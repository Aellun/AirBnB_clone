...
class TestHBNBCommand_help(unittest.TestCase):
    ...
    def test_help_show(self):
        h = "Display the string rep of a class instance of a given id"
        with patch("sys.stdout", new=StringIO()) as output:
...
class TestHBNBCommand_exit(unittest.TestCase):
    """the Unittests to test exit for HBNB command interpreter."""
...
class TestHBNBCommand_create(unittest.TestCase):
    """The Unittests to test create method for HBNB command interpreter."""
...
class TestHBNBCommand_show(unittest.TestCase):
    """The Unittests to test show method for HBNB command interpreter"""
    ...
    # if class intance id is missing
...
class TestHBNBCommand_destroy(unittest.TestCase):
    """The Unittests to test destroy method for HBNB command interpreter."""
...
class TestHBNBCommand_all(unittest.TestCase):
    """The Unittests to test all method for HBNB command interpreter."""
...
class TestHBNBCommand_update(unittest.TestCase):
    """the Unittests to test update method for HBNB command interpreter."""
...
class TestHBNBCommand_count(unittest.TestCase):
    """The Unittests to test count  method of HBNB comand interpreter."""
