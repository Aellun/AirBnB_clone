...
class TestPlace_instantiation(unittest.TestCase):
    ...
    checks if:
            istance of class is correct type,
            new instance is store in the models.storage.all().value(),
            id, created_at,updated_at,city_id, user_id,name,description
            number_rooms,number_bathrooms,max_guest,price_by_night
            latitude,longitude and amenity_ids are of correct type."""
...
class TestPlace_to_dict(unittest.TestCase):
    """Unittests to to_dict method of the class Place
        checks if output is dict 
        dict contains correct keys
        datetime attribute is converted to str
